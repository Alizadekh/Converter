  ...
  return (
    <div className={style.area}>
      <div className={style.inputArea}>
        ...
        >
          <path
            d="M23.3175 21.9938L26.9794 25.6538C27.1501 25.8306 27.2446 26.0674 27.2425 26.3132C27.2404 26.559 27.1418 26.7942 26.968 26.968C26.7941 27.1418 26.559 27.2404 26.3132 27.2425C26.0674 27.2447 25.8306 27.1502 25.6537 26.9794L21.9919 23.3175C19.5989 25.3677 16.5049 26.4114 13.359 26.2296C10.2132 26.0477 7.25999 24.6545 5.11922 22.3422C2.97844 20.0299 1.81646 16.9784 1.87711 13.8278C1.93775 10.6773 3.21631 7.67269 5.44449 5.44452C7.67266 3.21634 10.6773 1.93778 13.8278 1.87714C16.9783 1.81649 20.0299 2.97847 22.3422 5.11925C24.6545 7.26003 26.0477 10.2132 26.2296 13.359C26.4114 16.5049 25.3677 19.5989 23.3175 21.9919V21.9938ZM13.3333 23.3333C15.5833 23.3333 17.7413 22.4595 19.3249 20.8751C20.9084 19.2906 21.7822 17.1326 21.7822 14.8826C21.7822 12.6327 20.9084 10.4747 19.3249 8.89115C17.7413 7.30764 15.5833 6.43382 13.3333 6.43382C11.0834 6.43382 8.92542 7.30764 7.34191 8.89115C5.75839 10.4747 4.88457 12.6327 4.88457 14.8826C4.88457 17.1326 5.75839 19.2906 7.34191 20.8751C8.92542 22.4595 11.0834 23.3333 13.3333 23.3333Z"
            fill="#FF9500"
          />
        </svg>
      </div>
